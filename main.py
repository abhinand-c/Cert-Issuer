...
Congratulations on the successful completion of “Actuator’21,The Beginner’s Workshop” conducted virtually from May 23,2021 to May 30,2021 by Robocek GCEK. Thank you for your coordination which made the event a grant success even in the online mode.


And here in, we have attached the digital copy of your ‘Certificate of Participation’. In case of any discrepancies, feel free to contact us. We expect your support and devoted participation in the further journey of Robocek.
"""
...
for index, person in df.iterrows():
    ...
    mail.send_mail(subject=mail_subject, text_content=text_content, sender=HOST_MAIL, recipient=person['Mail'], html_message=html_output, mail_session=mail_session)
